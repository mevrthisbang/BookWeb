<%-- 
    ...
    Created on : Oct 22, 2020, 9:58:38 PM
    Author     : mevrthisbang
--%>
                            ...
                            <div class="ttr_menushape1">
                                ...
                                <div id="navigationmenu">
                                    ...
                                    <ul class="ttr_menu_items nav navbar-nav navbar-right">
                                        <li class="ttr_menu_items_parent dropdown"><a href="${pageContext.request.contextPath}/employee/employeeBookForm.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"><i class="fas fa-plus"></i></span> Create new book</a>
