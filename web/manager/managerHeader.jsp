<%-- 
    ...
    Created on : Oct 19, 2020, 9:43:09 PM
    Author     : mevrthisbang
--%>
                        ...
                        <div id="ttr_menu_inner_in">
                            ...
                            <div id="navigationmenu">
                                <div class="menu-center collapse navbar-collapse">
                                    <s:form cssClass="form-inline navbar-search" method="post" action="searchBookOrEmployee" theme="simple">
                                        <s:textfield cssClass="srchTxtManager" placeholder="Search" theme="simple" name="search"/>
                                        <s:select name="cboType" cssClass="cboType" list="#{'book':"Book", 'employee':'Employee'}" theme="simple" value="%{cboType}"/>
                                        <s:submit cssClass="srchBtnManager" value="Search"/>
                                    </s:form>
                                    <ul class="ttr_menu_itemsManager nav navbar-nav navbar-right">
                                        <li class="ttr_menu_items_parentManager dropdown"><a href="${pageContext.request.contextPath}/manager/managerBookForm.jsp" class="ttr_menu_items_parent_linkManager"><span class="menuchildicon"><i class="fas fa-plus"></i></span> Create new book</a>
                                            <hr class ="horiz_separator"/>
                                        </li>
                                        <li class="ttr_menu_items_parentManager dropdown"><a href="${pageContext.request.contextPath}/manager/managerEmployeeForm.jsp" class="ttr_menu_items_parent_linkManager"><span class="menuchildicon"><i class="fas fa-plus"></i></span> Create new employee</a>
                                            <hr class ="horiz_separator"/>
                                        </li>
                                        <li class="ttr_menu_items_parentManager dropdown"><s:a href="/AssignmentBookOnlineShopping/logout.action" cssClass="ttr_menu_items_parent_linkManager" theme="simple"><span class="menuchildicon"><i class="fas fa-sign-out-alt"></i></span> Logout</s:a>
                                            <hr class ="horiz_separator"/>
                                        </li>
                                    </ul>
                                </div>
